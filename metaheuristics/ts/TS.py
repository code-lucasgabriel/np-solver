...
class TS(abc.ABC, Generic[E]):
    ...
    def create_empty_sol(self) -> BaseSolution[E]:
        ...
        Returns:
            BaseSolution[E]: An empty solution object.
        """
        pass

    @abc.abstractmethod
    def neighborhood_move(self) -> BaseSolution[E]:
        """
        ...
        Returns:
            BaseSolution[E]: The new solution after performing a move.
        """
        pass
    ...
    def constructive_heuristic(self) -> BaseSolution[E]:
        ...
        Returns:
            BaseSolution[E]: A feasible initial solution.
        """
    ...
    def solve(self) -> BaseSolution[E]:
        ...
        Returns:
            BaseSolution[E]: The best feasible solution found by the search.
        """
