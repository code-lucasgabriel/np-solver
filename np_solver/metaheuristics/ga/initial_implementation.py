...
class BaseGA(Generic[G, F], ABC):
    ...
    def __init__(
        ...
        Args:
            evaluator (BaseEvaluator[F]): The objective function being optimized.
        ...
        self.chromosome_size: int = self.evaluator.get_domain_size()
    ...
    def get_problem_name(self) -> str:
        ...
        Returns:
            str: Name of the optimization probem.
        """
        pass
    ...
    def read_instance(self, filename: str) -> None:
        ...
        Raises:
            ...
            ValueError: If the file is malformed or its data is invalid.
        """
        pass
    """
